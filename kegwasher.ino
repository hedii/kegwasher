...
step_t STEPS_WASH_KEG_PRESSURIZE[] = {
  ...
  // 93sec (1min33)
  {CONFIG_RINCE, 10},
  {CONFIG_RINCE_PURGE, 17},
  {CONFIG_RINCE, 3},
  {CONFIG_RINCE_PURGE, 10},
  {CONFIG_RINCE, 10},
  {CONFIG_RINCE_PURGE, 13},
  {CONFIG_RINCE, 10},
  {CONFIG_RINCE_PURGE, 20},
  // 162sec (2min42)
  {CONFIG_CLEAN, 10},
  {CONFIG_CLEAN_PURGE, 7},
  {CONFIG_CLEAN, 10},
  ...
  {CONFIG_CLEAN_PURGE, 15},
  {CONFIG_CLEAN, 20},
  {CONFIG_CLEAN_PURGE, 22},
  // 94sec (1min34)
  {CONFIG_RINCE, 3},
  {CONFIG_RINCE_PURGE, 10},
  {CONFIG_RINCE, 7},
  {CONFIG_RINCE_PURGE, 11},
  {CONFIG_RINCE, 10},
  {CONFIG_RINCE_PURGE, 20},
  {CONFIG_RINCE, 10},
  {CONFIG_RINCE_PURGE, 23},
  // 115sec (1min55)
  {CONFIG_SANITIZE, 10},
  {CONFIG_SANITIZE_PURGE, 15},
  {CONFIG_SANITIZE, 10},
...
// 408sec (6min47)
step_t STEPS_WASH_NEW_KEG_PRESSURIZE[] = {
  // 7sec
  {CONFIG_DRAIN, 7},
  // 43sec (0min43)
  {CONFIG_RINCE, 10},
...
mode_t MODES[] = {
  ...
  {"Lav. CO2 neuf", STEPS_WASH_NEW_KEG_PRESSURIZE},
